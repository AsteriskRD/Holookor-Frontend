...
import AssignmentCard from "../../components/study-hub/assignment-card.jsx";
  ...
  const assignmentData = [
    {
      ...
      description:
        "Complete problems 1 - 20 from chapter 5. Show all working and explain your reasoning.",
    ...
    },
    {
      ...
      description:
        "Implement a balanced BST with insert, delete, and search operations.",
            ...
            <div className="mb-8 flex justify-between items-center p-4">
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Assignments, Quiz and Study Materials
                </p>
              </div>
              <div>
                {/* Mobile AI Assistant */}
                ...
                <div className="relative">
                  ...
                  {filterOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                      {["All Assignments", "Pending", "Completed"].map(
                        (option) => (
                          <button
                            key={option}
                            onClick={() => {
              ...
              <div className="space-y-4">
                ...
                {activeTab === "quiz" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Mock quiz cards */}
                    {[1, 2, 3].map((q) => (
                      <div key={q} className="bg-gray-50 rounded-md p-4">
                ...
                {activeTab === "resources" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {[1, 2, 3, 4].map((r) => (
                      <div
                        key={r}
                        className="bg-white rounded-md border border-gray-100 p-4 shadow-sm"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xs text-gray-500">PDF • 2 MB</p>
                          </div>
                          <div className="text-xs text-gray-500">Math</div>
                        </div>

                        <div className="mt-4 flex gap-2">
                          <button className="px-3 py-2 bg-green-600 text-white rounded-md text-sm">
                            Download
                          </button>
                          <button className="px-3 py-2 bg-gray-100 text-gray-800 rounded-md text-sm">
                            Open
                          </button>
                        </div>
                      </div>
