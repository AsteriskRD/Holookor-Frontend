...
export default function ConfirmBooking({
  ...
  return (
  <>
    {showPaymentModal && <PaymentSuccessfulModal onStartLiveSession={handleStartLiveSession} />}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8">
        ...
        <div className="space-y-4 sm:space-y-6">
            {/* Booking Summary */}
            <div className="p-4 sm:p-6 rounded-lg border" style={{ borderColor: "#e5e7ea", backgroundColor: "#ffffff" }}>
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-xs font-semibold mb-1" style={{ color: "#6d717f" }}>
                    Tutor
                  </p>
                ...
                <div>
                  ...
                  <p style={{ color: "#0a0a0a" }}>
                    {selectedTimes.length > 0 ? selectedTimes.join(", ") : "MON 8 - 9 PM"}
                  </p>
                </div>
                <div>
                  <p className="text-xs font-semibold mb-1" style={{ color: "#6d717f" }}>
                  ...
                  <p style={{ color: "#0a0a0a" }}>{selectedTimes.length || 1}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 rounded-lg border" style={{ borderColor: "#e5e7ea", backgroundColor: "#ffffff" }}>
              ...
              <div className="space-y-3 pb-4 border-b" style={{ borderColor: "#e5e7ea" }}>
            ...
            <div className="p-4 sm:p-6 rounded-lg border" style={{ borderColor: "#e5e7ea", backgroundColor: "#ffffff" }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <button
                  ...
                  style={{
                    borderColor: paymentMethod === "credit-card" ? "#3da755" : "#e5e7ea",
                    backgroundColor: paymentMethod === "credit-card" ? "#e9fbe6" : "#ffffff",
                    color: paymentMethod === "credit-card" ? "#3da755" : "#0a0a0a",
                  }}
                >
                  💳 Credit Card
                </button>
                <button
                  ...
                  style={{
                    borderColor: paymentMethod === "paypal" ? "#3da755" : "#e5e7ea",
                    backgroundColor: paymentMethod === "paypal" ? "#e9fbe6" : "#ffffff",
              ...
              {paymentMethod === "credit-card" && (
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <label htmlFor="save-card" className="text-sm" style={{ color: "#6d717f" }}>
              ...
              {/* Action Buttons */}
              <div className="flex flex-col sm:flex-row justify-end gap-3 mt-6" style={{ borderColor: "#e5e7ea" }}>
                <Button
                  variant="outline"
