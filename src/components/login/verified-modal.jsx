...
export function VerifiedModal({ onContinue }) {
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-sm w-full mx-auto">
        ...
        {/* Title */}
        <h2 className="text-xl font-bold text-center text-[#1a1a1a] mb-2">Verified</h2>

        {/* Description */}
        <p className="text-center text-gray-600 text-sm mb-6">
          You can now enter your new password for your account
        </p>
